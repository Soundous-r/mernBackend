...
const ApplyDoctor = () => {
  ...
  return (
    <Layout>
        <h2 className='text-center m-2 fw-bold ' style={{color:"#061e54",
    animation: "fadeSlideIn 1s ease forwards",
    opacity: 0,
    transform: "translateY(20px)",}}>Apply as a doctor</h2>
          
        <Form layout='vertical'  onFinish={handleFinish} className='m-5 ' style={{
    animation: "fadeSlideIn 1s ease forwards",
    opacity: 0,
    transform: "translateY(20px)",}} >
            <h4 className='m-3' style={{color:"#c0ccffe6", textShadow:"0 0 1px gray",
    animation: "fadeSlideIn 1s ease forwards",
    opacity: 0,
    ...
    transform: "translateY(20px)",}}>Professional Information:</h4>
            ...
            type="submit" style={{animation: "fadeSlideIn 1s ease forwards",
    opacity: 0,
    transform: "translateY(20px)",}}
          >
           Submit
